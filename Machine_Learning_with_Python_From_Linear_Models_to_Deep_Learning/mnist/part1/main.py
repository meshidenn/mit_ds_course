...
# print('0.5 softmax test_error=', run_softmax_on_MNIST(temp_parameter=0.5))
# print('1 softmax test_error=', run_softmax_on_MNIST(temp_parameter=1))
# print('2 softmax test_error=', run_softmax_on_MNIST(temp_parameter=2))
...
def run_softmax_on_MNIST_pca(train_pca, text_pca, temp_parameter=1):
    """
    Trains softmax, classifies test data, computes test error, and plots cost function
...
# print('softmax test_error_pca=', run_softmax_on_MNIST_pca(train_pca, test_pca, temp_parameter=1))
...
def run_softmax_on_MNIST_cube(train_cube, text_cube, temp_parameter=1):
    """
    Trains softmax, classifies test data, computes test error, and plots cost function
    ...
    plot_cost_function_over_time(cost_function_history)
    print(theta.shape, test_cube.shape)
...
print('softmax test_error_cube=', run_softmax_on_MNIST_cube(train_cube, test_cube, temp_parameter=1))
