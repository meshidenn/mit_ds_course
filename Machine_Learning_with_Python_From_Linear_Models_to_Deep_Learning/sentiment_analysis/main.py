...
train_bow_count_features = p1.count_bow_feature_vectors(train_texts, dictionary)
val_bow_count_features = p1.count_bow_feature_vectors(val_texts, dictionary)
test_bow_count_features = p1.count_bow_feature_vectors(test_texts, dictionary)
